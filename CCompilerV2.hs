...
module CCompilerV2 where

import Ast
import ICInterpreter hiding (State)
import TestsProject
...
testCompile :: String -> IC_Program
testCompile str = compile $ (\(Just (x,y))->x) (parse parser str)

testCompileO :: String -> IC_Program
...
optimizeJR :: IC_Program -> Int -> Int -> IC_Program
optimizeJR [] _ _ = undefined
